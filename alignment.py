...
def align_sequences(transcript_words: list[dict], 
    ...
    Args:
        ...
        script_words: List of words from official script
    ...
    while i > 0 and j > 0 and traceback[i][j] is not None:
        if traceback[i][j] == 'diag':
            ...
            s_word = script_words[j-1]
            similarity = word_similarity(t_word.lower(), s_word.lower())
